...
- ⚡ **AI Повышение плавности (60 / 120 FPS)**: Интерполяция кадров через нейросеть RIFE (Vulkan GPU) и аппаратный FFmpeg MCI для создания ультраплавных роликов (60/120 FPS) из 24/30 FPS исходников.
- 📂 **Aura Video Studio (Drag & Drop)**: Перетаскивание видеофайлов с ПК или выбор через проводник для локальной обработки (кадрирование, 60 FPS, обрезка, сжатие, GIF).
