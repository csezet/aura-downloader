...
- 📸 **Instagram Фото, Карусели и Рилсы**: Загрузка одиночных фотографий в максимальном JPG-разрешении и многостраничных постов (каруселей) с интерактивным диалогом выбора снимков ("ВЫБРАТЬ ВСЕ", превью, номера фото).
